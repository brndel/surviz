...
enum class Language(private val code: String, private val strings: Map<String, String>) {
    English(
        "en", mapOf(
            ...
            Labels.USER_GUIDE_PROJECT_SCREEN_SINGLE_VALUE_DESCRIPTION to "In the Single Values tab, individual values can be configured.",
            Labels.USER_GUIDE_PROJECT_SCREEN_SINGLE_VALUE_ADD to "Add and configure individual value",
            Labels.USER_GUIDE_PROJECT_SCREEN_SINGLE_VALUE_ADD_DESCRIPTION to "By clicking on the + New button, a new individual value can be added.\n" + "\n" + "An unit can be assigned to the individual value in the Unit text field.\n" + "\n" + "A column schema can be assigned to the individual value in the Column Schema text field. Further information can be found in the user manual under \$Individual Value Column Schema\$.\n" + "\n" + "By clicking the button below the Column Schema text field, an icon for the individual value can be selected.\n" + "\n" + "By clicking the + below the icon button, an icon level can be added.\n" + "\n" + "An individual icon can be added to an icon level. Additionally, a lower threshold can be set in the text field next to the icon button. This indicates at which value of the individual value the icon changes.\n" + "\n" + "The order of individual values can be adjusted by clicking the button with the three stacked lines and using drag and drop.By clicking on the + New button, a new individual value can be added.\n" + "\n" + "An unit can be assigned to the individual value in the Unit text field.\n" + "\n" + "A column schema can be assigned to the individual value in the Column Schema text field. Further information can be found in the user manual under \$Individual Value Column Schema\$.\n" + "\n" + "By clicking the button below the Column Schema text field, an icon for the individual value can be selected.\n" + "\n" + "By clicking the + below the icon button, an icon level can be added.\n" + "\n" + "An individual icon can be added to an icon level. Additionally, a lower threshold can be set in the text field next to the icon button. This indicates at which value of the individual value the icon changes.\n" + "\n" + "The order of individual values can be adjusted by clicking the button with the three stacked lines and using drag and drop.",
            Labels.USER_GUIDE_PROJECT_SCREEN_SINGLE_VALUE_SCHEME to "Individual Value Column Schema",
            Labels.USER_GUIDE_PROJECT_SCREEN_SINGLE_VALUE_SCHEME_DESCRIPTION to "By specifying a column schema, SurViz can automatically create a list of columns from each situation's columns, which, when summed, indicate the value of this individual value.\n" + "\n" + "The schema consists of a precisely defined \$prefix\$ of a column name and an arbitrary \$suffix\$ of a column name, which is replaced with an .\n" + "The schema \$prefix\$ selects all columns of the Ngene file whose name is structured as follows: \$Situation\$.\$PrefixSuffix\$.\n" + "\n" + "Example:\n" + "There are the columns:\n" + "\n" + "\$car.cost_toll\$\n" + "\$car.cost_gasoline\$\n" + "\$car.fuel\$\n" + "\$car.disposal\$\n" + "\$car.access\$\n" + "for the situation \$car\$.\n" + "\n" + "By the schema \$cost*\$, the following columns are selected in the situation \$car\$:\n" + "\n" + "\$car.cost_toll\$\n" + "\$car.cost_gasoline\$\n" + "However, in this example, the schema \$c*\$ would be sufficient to select the columns listed above.\n" + "\n" + "By the schema \$fuel*\$, the following columns are selected in the situation \$car\$:\n" + "\n" + "\$car.fuel\$\n" + "\$car.disposal\$\n" + "\$car.access\$\n" + "By the schema \$fuel_*\$, the following columns are selected in the situation \$car\$:\n" + "\n" + "\$car.disposal\$\n" + "\$car.access\$\n" + "The column \$car.fuel\$ is no longer selected here because it does not contain the suffix \$fuel_\$.",
            Labels.USER_GUIDE_PROJECT_SCREEN_SITUATION to "Situations tab",
            Labels.USER_GUIDE_PROJECT_SCREEN_SITUATION_DESCRIPTION to "In the Situations tab, the individual situations of a project can be configured.",
            Labels.USER_GUIDE_PROJECT_SCREEN_SITUATION_EDIT to "Configure situation",
            Labels.USER_GUIDE_PROJECT_SCREEN_SITUATION_EDIT_DESCRIPTION to "To configure a situation, it must first be selected.\n" + "\n" + "In the Name text field, a name can be assigned to the situation.\n" + "\n" + "Below the Name text field, a color can be set by specifying a hex code or by adjusting the color sliders.\n" + "\n" + "Under Individual Value Columns, columns can be assigned to each individual value for calculating the value. By clicking on the button next to the icon of each individual value, a dropdown menu opens. In this menu, the type of column calculation can be selected.\n" + "\n" + "If 'Schema' is selected, the previously defined list of columns by the schema is used.\n" + "If 'Null' is selected, this column is always zero.\n" + "If 'Timeline' is selected, the timeline columns are chosen.\n" + "If 'Select' is selected, the columns can be manually selected.\n" + "\n" + "Under Timeline, the timeline of the situation can be adjusted. Individual sections of the timeline can be added by clicking the + button. Like with the individual values, an icon can be assigned to each section by clicking the icon button. Next to the icon button, the column containing the value of this section can be specified. Additionally, the type of line can be specified. Just like with the individual values, the order of the sections can be adjusted by drag and drop.",
