 ...
 * @ui TextField this card shows a TextField for the `unit` and the `colorScheme` of the given [SingleValueConfig]
 * @ui SingleValueIconCard this card shows a SingleValueIconCard for the icons of the given [SingleValueConfig]
 */
@Composable
